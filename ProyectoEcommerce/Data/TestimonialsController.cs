...
namespace ProyectoEcommerce.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public TestimonialsController(ProyectoEcommerceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,Author,Comment")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TestimonialId,Author,Comment")] Testimonial testimonial)
        {
